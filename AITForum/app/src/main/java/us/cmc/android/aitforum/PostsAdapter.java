...
/**
 * Created by alexclemens on 11/14/16.
 */
...
import us.cmc.android.aitforum.model.Post;
...
public class PostsAdapter extends RecyclerView.Adapter<PostsAdapter.ViewHolder> {
    ...
    public PostsAdapter(Context context, String uId) {
        ...
        postList.add(new Post("1", "Author", "DemoTitle", "Body"));
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if(uId.equals(tmpPost.getUid())){
            //display delete button and set onlicklistener for it
        }
